...
<div class="showHideCont">
    <a class="showHide minus" id="hide-3" href="#" onclick="Config_Block_Course_Menu.section_hide(this, 'div_links'); return false;">
        <?php echo get_string('hide', $this->blockname) ?>
    </a>
    <a class="showHide plus" id="show-3" href="#" onclick="Config_Block_Course_Menu.section_show(this, 'div_links'); return false;" style="display: none">
...
<div id="div_links">
    <div id="linksEnableContainer">
        <div class="expandableTreeTd">
            <a href="" onclick="Config_Block_Course_Menu.L.changeEnableLinks(); return false" class="enableDisable">
...
Config_Block_Course_Menu.L = new function() {
    ...
    return {
        ...
        changeEnableLinks: function() {
            ...
            var enabInput = Config_Block_Course_Menu.$("id_config_linksEnable");
            var img = Config_Block_Course_Menu.$("img_config_linksEnable");
...
Config_Block_Course_Menu.addLoadEvent(function () {
    Config_Block_Course_Menu.L.init();
});
